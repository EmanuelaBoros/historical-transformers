# HIPE Fine-tuning and Inference

```
torchrun --nnodes 1 --nproc_per_node 2 finetuning.py --enable_fsdp --use_peft --peft_method lora --model_name meta-llama/Llama-2-7b-hf --pure_bf16 --output_dir ./exp/hipe_llama7b_prompt_1 --use_fast_kernels --dataset hipe_dataset --save_model


python inference.py --model_name meta-llama/Llama-2-7b-hf --prompt_file data/test_prompt.txt --peft_model exp/hipe_llama7b_prompt_1/epoch-2/ --max_padding_length 4000
```
